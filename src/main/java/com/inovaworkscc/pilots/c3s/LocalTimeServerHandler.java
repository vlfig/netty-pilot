...
import com.inovaworkscc.pilots.c3s.LocalTimeProtocol.Continent;
import com.inovaworkscc.pilots.c3s.LocalTimeProtocol.DayOfWeek;
import com.inovaworkscc.pilots.c3s.LocalTimeProtocol.LocalTime;
import com.inovaworkscc.pilots.c3s.LocalTimeProtocol.LocalTimes;
import com.inovaworkscc.pilots.c3s.LocalTimeProtocol.Location;
import com.inovaworkscc.pilots.c3s.LocalTimeProtocol.Locations;
...
public class LocalTimeServerHandler extends SimpleChannelUpstreamHandler {
    ...
    public void messageReceived(
        ...
        final Locations locations = (Locations) e.getMessage();
        final long currentTime = System.currentTimeMillis();

        final LocalTimes.Builder builder = LocalTimes.newBuilder();
        for (final Location l: locations.getLocationList()) {
