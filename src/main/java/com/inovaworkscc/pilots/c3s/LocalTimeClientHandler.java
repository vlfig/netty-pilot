...
public class LocalTimeClientHandler extends SimpleChannelUpstreamHandler {
    ...
    public List<String> getLocalTimes(Collection<String> cities) {
        final Locations.Builder builder = Locations.newBuilder();

        for (final String c: cities) {
            final String[] components = c.split("/");
        ...
        for (final LocalTime lt: localTimes.getLocalTimeList()) {
            result.add(
    ...
    public void messageReceived(
        ...
        final boolean offered = answer.offer((LocalTimes) e.getMessage());
        assert offered;
    }
